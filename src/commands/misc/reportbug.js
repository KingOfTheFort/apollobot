...
module.exports = class ReportBugCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        Sends a message to the Apollo Support Server's bug report channel.
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [Apollo Support Server](https://discord.gg/pnYVdut) to further discuss your issue.
        Additionally, feel free to submit an issue on [GitHub](https://github.com/sabattle/ApolloBot/issues).
      `) 
