module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`Apollo has left ${guild.guild_name}`);
  }

  client.logger.info('Apollo is now online');
  client.logger.info(`Apollo is running on ${client.guilds.cache.size} server(s)`);
};
